...
class $AssetsIconsGen {
  ...
  /// File path: assets/icons/app_logo_without_text.png
  AssetGenImage get appLogoWithoutText =>
      const AssetGenImage('assets/icons/app_logo_without_text.png');

  /// List of all assets
  List<AssetGenImage> get values => [appLogo, appLogoWithoutText];
}
...
class $AssetsImagesGen {
  ...
  /// List of all assets
  List<AssetGenImage> get values => [noData, onboarding];
}

class $AssetsKeysGen {
  const $AssetsKeysGen();

  /// File path: assets/keys/push_notification_key.json
  String get pushNotificationKey => 'assets/keys/push_notification_key.json';

  /// List of all assets
  List<String> get values => [pushNotificationKey];
}
